...
function codes_register_data() {
	...
	register_post_meta(
		...
		'_codes_language',
		array(
			'type'        => 'string', // Validate and sanitize the meta value as a string. // Options: 'string', 'boolean', 'integer', 'number', 'array', and 'object'.
			'description' => __( 'Selected language for the custom code', 'custom-codes' ), // Shown in the schema for the meta key.
